...
bot.on("guildCreate", function(guild) {
    ...
    const embed = new Discord.RichEmbed()
        ...
        .addField(`:wave: Welcome!`, `Thanks for adding Discord Moderator to your server! You might be wondering, how do I setup Discord Moderator bot? Well, I'll show you.`)
        ...
        .addField(`Anything Else?`, `If there is, you can always join the support server or DM a Developer. Developers you can message include ` + "`고스트 라이더 Aka Ayush#1999, Uthsho#0440`" + `. The support server should be in the ` + "`about`" + ` command`)
        .setColor(0x00ff00)
